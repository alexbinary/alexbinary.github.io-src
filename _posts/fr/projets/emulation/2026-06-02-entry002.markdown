...
permalink: /fr/2026/06/02/emulation-002
lang: fr
lang_en: /en/2026/06/02/emulation-002
---

La dernière fois nous avons découvert le 6502 et validé son fonctionnement. Nous avons câblé en dur une donnée sur le bus, de sorte à envoyer au CPU l'instruction `NOP` (« No Operation ») quelque soit l'adresse qu'il lit.
