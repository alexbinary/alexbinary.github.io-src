...
entry: "006"
title: Prise en main du 6522 "Versatile Interface Adapter"
...
permalink: /fr/projets/emulation/billets/006
lang: fr
lang_en: /en/projects/emulation/posts/006
---

J'ai un système basé sur le 6502 que je peux programmer librement. L'objectif maintenant est d'ajouter des LEDs et des boutons pour pouvoir écrire des programmes interactifs.


## Le rôle du 6522

Le 6502 seul n'est pas en mesure de piloter directement des LEDs et des boutons, car les seules choses qu'il peut faire directement c'est lire et écrire sur les bus d'adresse et de données. Pour piloter une LED ou lire un bouton il faut un système intermédiaire qui s'interface avec la LED ou le bouton d'un côté, et communique avec le CPU via le bus de l'autre côté.
...
Je n'arrive pas à faire fonctionner le 6522, mais en revoyant [la vidéo de Ben Eater](https://www.youtube.com/watch?v=yl8vPW5hydQ) consacrée à son installation j'ai l'idée de construire un latch comme il l'a montré dans [cette vidéo](https://www.youtube.com/watch?v=YW-_GkUguMM), et d'essayer de l'interfacer avec le CPU. C'est un exercice intéressant. Si ça fonctionne ça permettra d'avoir déjà une sortie pilotable par le 6502, et donc d'avoir enfin des résultats observables directement et d'écrire des programmes qui font quelque chose.
