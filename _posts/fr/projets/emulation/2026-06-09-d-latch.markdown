...
title: Comment implémenter une bascule D avec des portes logiques
...
lang_en: 
teaser_short:
    Dans cet article nous voyons comment créer une bascule D de zéro avec des composants élémentaires appelés portes logiques
teaser:
    Aujourd'hui nous voyons comment créer une bascule D avec des portes logiques. Pour essayer de générer de nouvelles idées je revisionne la vidéo de Ben Eater sur le VIA.
---
