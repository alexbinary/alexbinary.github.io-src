...
lang_en: 
teaser:
    Aujoud'hui nous voyons comment créer une bascule D avec des portes logiques. Pour essayer de générer de nouvelles idées je revisionne la vidéo de Ben Eater sur le VIA.
---
