...
entry: "001"
title: Présentation du projet et découverte du 6502
...
Dans ce genre de projets découverte j'aime partir de la base et expérimenter petit à petit avec les composants pour valider le fonctionnement supposé étape par étape, confronter mes prédictions à la réalité, et développer une compréhension solide des choses. Dans cette première session je commence par prendre en main le 6502 et jouer avec les bus d'adresse et de données et le vecteur reset.
