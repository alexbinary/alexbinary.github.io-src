...
entry: "004"
title: Introducing shift registers
topics: [6502, arduino, electronics, programming]
image: /assets/projects/emulation/004/IMG_7408.JPG
githubs:
- https://github.com/alexbinary/arduino-eeprom-programmer
permalink: /en/projects/emulation/posts/004
lang: en
lang_fr: /fr/projets/emulation/billets/004
---
...
<div class="inline-image-container">
    ...
    <div class="inline-image-container-row">
        ...
        {% include inline-image-item.html
            url="/assets/projects/emulation/004/IMG_7402.JPG"
...
<div class="inline-image-container mobile-column force-desktop-full-width">
    ...
    <div class="inline-image-container-row">
        ...
        {% include inline-video-item.html
            url="/assets/projects/emulation/004/IMG_7403.mp4"
...
<div class="inline-image-container mobile-column">
    ...
    <div class="inline-image-container-row">
        ...
        {% include inline-image-item.html
            url="/assets/projects/emulation/004/push.png"
...
<div class="inline-image-container">
    ...
    <div class="inline-image-container-row">
        ...
        {% include inline-image-item.html
            url="/assets/projects/emulation/004/shift.png"
...
<div class="inline-image-container force-desktop-full-width">
    ...
    <div class="inline-image-container-row">
        ...
        {% include inline-image-item.html
            url="/assets/projects/emulation/004/IMG_7408.JPG"
            legend="Setup with two shift registers"
        %}

        {% include inline-video-item.html
            url="/assets/projects/emulation/004/IMG_7410.mp4"
