...
At this point the hardware system is almost complete. I can't get the 6522 to work, but I'll be making custom peripherals for now, which is an unexpected but interesting side quest. After that I will be able to start writing interactive programs and think about emulation.
