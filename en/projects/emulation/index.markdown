...
To get started, I'm following [Ben Eater's video series dedicated to building a computer based on the 6502](https://www.youtube.com/playlist?list=PLowKtXNTBypFbtuVMUVXNR0z1mu7dp7eH). I begin by mounting the 6502 on a breadboard, connecting the power supply and basic control signals, and adding a reset button. The clock signal is generated by a module based on a 555 timer circuit that I built previously following [Ben Eater's videos on the subject](https://www.youtube.com/watch?v=kRlSFm519Bo). I'm using an Arduino Uno as a power source and for making observations afterward.
...
The Arduino is nice and all, but in the final system the data will be stored in a memory chip. Here I am using a 32KB EEPROM. This type of memory is intended to be used as read-only memory, but it can be erased and programmed electronically.
...
<div class="inline-image-container">
    ...
    <div class="inline-image-container-row">
        ...
        {% include inline-video-item.html
            ...
            legend="Observing the data traveling across the bus"
        %}
