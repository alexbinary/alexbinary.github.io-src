...
Aujourd'hui j'ai quasiment terminé le système hardware. Je rencontres des difficultés avec le 6522 mais je prévois de les contourner avec des périphériques fait maison. C'est un petit détour inattendu mais très interressant. Ensuite je pourrai écrire des programmes interactifs et commencer à réfléchir à l'émulation.
